...
```bash
cd app/Modules && swift test --filter RefreshFootprintTests \
...
```bash
cd app/Modules && swift test --filter HaulTargetPlannerTests \
...
```bash
cd app/Modules && swift test --filter HaulRunTests \
...
```bash
cd app/Modules && swift test --filter HaulRunEndToEndTests \
...
```bash
cd app/Modules && swift test --filter NewHaulRunFeatureTests \
