...
- [Star map main-thread load](starmap-main-thread-load.md) — the four costs that jammed other windows + lagged ship icons, and the 2026-07-23 lightening (frame pacing, label throttle, shared OrreryLayout, emission pixel-snapping, SystemDecodeCache).
