...
CREATE TABLE "directives" (
  ...
  "createdAt" TEXT NOT NULL,
  "updatedAt" TEXT NOT NULL
, "controllerCode" TEXT, "roamCentre" TEXT, "fleetTag" TEXT, "sourceRelayCode" TEXT, "claimedRelayCode" TEXT, "deletedAt" TEXT, "theatreDepot" TEXT, "freighterCodes" TEXT NOT NULL DEFAULT '[]', "botCodes" TEXT NOT NULL DEFAULT '[]', "payloadCode" TEXT) STRICT;
